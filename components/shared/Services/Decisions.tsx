      ...
      <div className="w-full grid grid-cols-3 gap-[20px]">
        <div className="flex flex-col items-center justify-center gap-[50px] col-span-1 ">
          ...
          <div className="w-[500px] p-[50px] border border-[var(--color-gray_15)] bg-[var(--color-gray_10)] shadow-2xl flex flex-col items-start justify-between gap-[30px] rounded-2xl ">
            <h2 className="text-2xl font-bold leading-[150%] ">
            ...
            <button className="text-lg font-normal leading-[150%] w-full h-[62px] rounded-xl border border-[var(--color-gray_10)] bg-[var(--color-gray_08)] flex items-center justify-center shadow-2xl hover:bg-purple-600 transition-all duration-300  ">
              Learn More
            </button>
          </div>
        </div>
