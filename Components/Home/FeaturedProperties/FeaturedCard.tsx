...
const FeaturedCard = ({ item }: { item: PropertyItem }) => {
  return (
    <div className="md:w-[400px] 2xl:w-[490px] h-auto p-10 flex items-center justify-start flex-col text-white border border-[var(--color-gray_15)] rounded-2xl gap-[30px] ">
      {/* Image */}
      ...
      <div className="flex gap-1 w-full justify-start">
        <div className="flex items-center space-x-2 px-[10px]  2xl:px-[14px] py-1 bg-[var(--color-gray_10)] border border-[var(--color-gray_15)] rounded-full ">
          <IoBed size={24} />
