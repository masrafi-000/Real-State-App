      ...
      <div className="grid grid-cols-3 gap-[20px]">
        ...
        <div className=" border border-[var(--color-gray_10)] p-[50px] col-span-2 rounded-xl bg-[var(--color-gray_10)] shadow-2xl flex flex-col items-start justify-center gap-[30px] hover:shadow transition-all duration-300">
            <div className="flex items-center justify-between gap-2 w-full">
                <h1 className="text-3xl font-bold leading-[150%] ">Experience Effortless Property Management</h1>
                <button className="flex items-center justify-center border border-[var(--color-gray_15)] rounded-xl px-6 py-[18px] bg-[var(--color-gray_08)] hover:bg-purple-600 transition-all duration-300 text-lg font-medium leading-[150%]  cursor-pointer ">Learn More</button>
            </div>
